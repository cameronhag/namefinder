...
![NameClaim results page for Stackform showing trademark, domain, and social handle availability in a single search](/guides/domain-social-availability-hero.png)
<div className="h-2" />
...
If you're forming an LLC specifically, the [LLC name availability check guide](/guides/llc-name-availability-check) walks through the state Secretary of State plus federal trademark layer in 20 minutes, which complements the domain and social work below.
...
![Three-layer diagram of business name availability: domain TLDs as layer one, primary social handles as layer two, and secondary platform handles as layer three](/guides/three-layer-diagram.png)
<div className="h-2" />
...
![Namecheap Search](/guides/namecheap-check.png)
<div className="h-2" />
...
![Instagram Signup Page](/guides/instagram-signup.png)
<div className="h-2" />
