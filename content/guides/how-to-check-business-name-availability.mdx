...
![Three-layer diagram of business name availability: domain TLDs as layer one, primary social handles as layer two, and secondary platform handles as layer three](/guides/domain-social-availability-hero.png)
<div className="h-2" />
