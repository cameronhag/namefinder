...
If you found nothing concerning, you've done a more thorough search than most founders run before naming their business. Move on to checking domain and social handle availability. If you're forming an LLC, follow that with the state Secretary of State search, covered in the [LLC name availability check guide](/guides/llc-name-availability-check).
