...
If you're forming an LLC, run the state Secretary of State search first using the [LLC name availability check guide](/guides/llc-name-availability-check), then come back here to do the federal trademark layer. State and federal are independent and you need both.
...
![USPTO Search Page](/guides/uspto-search.png)
<div className="h-2" />
...
![USPTO Results Page](/guides/uspto-results.png)
<div className="h-2" />
...
![USPTO Live Filter](/guides/uspto-live-filter.png)
<div className="h-2" />
...
![USPTO Class Filter](/guides/uspto-class-view.png)
<div className="h-2" />
...
![USPTO Class Filter](/guides/uspto-registration-info.png)
<div className="h-2" />
...
![USPTO Similar Marks](/guides/alternative-name.png)
<div className="h-2" />
