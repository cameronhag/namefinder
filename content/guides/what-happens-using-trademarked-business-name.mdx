...
Search before you commit. Use [USPTO's free search tool walkthrough](/guides/how-to-do-free-uspto-trademark-search) for a thorough first pass, or [NameClaim](/) for a faster automated check before you invest the time. If you're forming an LLC, the [LLC name availability check guide](/guides/llc-name-availability-check) walks through the state plus federal layers together.
